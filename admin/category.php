...
$sql=mysqli_query($bd, "insert into category(categoryName) values('$category')");
...
<div class="controls">
<input type="text" placeholder="Enter State Name"  name="category" class="span8 tip" required>
</div>
</div>
